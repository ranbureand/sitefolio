...
In the above example, the first panel of page 6 from the comic book *Asterix And The Banquet* depicts three distinct events that, technically [^panel], happen at the same time:

...
description: 'Jots is an ongoing collection of bits from inspiring pieces about design and development, jotted down to recall later as food for thought.'
exordium: '*Jots* is an ongoing collection of bits from inspiring pieces about design and development, jotted down to recall later as food for thought.'
...
<div class="figures">
  {% include image.html
      ...
      alt="A screenshot of Jots, a site that collects bits from inspiring pieces about design and development."
      color="#8F6EFA"
  %}
</div>
